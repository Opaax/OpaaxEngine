 ...
 */
class OPAAX_API OpaaxFileSystem
{
    //-----------------------------------------------------------------
    // Functions
    //-----------------------------------------------------------------
public:
     ...
     */
    static STDFileSystem::path GetPathAtProjectDir(const OSTDString& InPath);
     ...
     */
    static STDFileSystem::path GetPathIfNCreate(const OSTDString& InPath);
     ...
     */
    static OSTDString GetTimeStamp();
     ...
     */
    static OSTDString GetTimeStampDirectoryFriendly();
};
