...
// =============================================================================
// EngineSubsystemOld — the OLD engine-subsystem hierarchy (CoreEngineApp-coupled).
// Quarantined out of the live Core/Engine/Subsystems/EngineSubsystem.h during the
// old-world Legacy split (2026-07-19). NOT compiled (Legacy is dropped from the DLL
// glob); kept for reference until the old world is deleted. See ARCHITECTURE.md X1.
// =============================================================================
