...
namespace Opaax
{
    ...
    // =============================================================================
    // Frame
    constexpr float F30_HZ  = 1.f / 30.f;
    constexpr float F60_HZ  = 1.f / 60.f;
    constexpr float F90_HZ  = 1.f / 90.f;
    constexpr float F120_HZ = 1.f / 120.f;
    constexpr float F144_HZ = 1.f / 144.f;
    constexpr float F160_HZ = 1.f / 160.f;
    // End Frame
    // =============================================================================
